...
function managelogindata(formmodelid,formloadServeripwithport,formloadPointedwebservice){

            if(typeof(Storage) !== "undefined") {                
                var aduname = sessionStorage.ADusername;
                var adpwd = sessionStorage.ADpassword;
                Getloginuserdata_formload(aduname,formloadServeripwithport,formloadPointedwebservice);
                var rolegroupid = sessionStorage.RoleID;
                var arrayloginuser_data = [aduname,adpwd,rolegroupid];
                
                var modelid = formmodelid;
                CheckPageisaccess(modelid,rolegroupid,formloadServeripwithport,formloadPointedwebservice);
                                    ...
                                    if(searchop=='nic' && searchop!='mobile')
                                    {
                                        ...
                                        mobile = ''
                                                    var settings = {
                                                        "async": false,
                                                        "crossDomain": true,
                                                        "url": "https://passbook.boc.lk/BOCPassbook/webresources/customerService/getCustomerByNic/"+nic,    //LIVE url 
                                                        //"url": "https://passbook.boc.lk/BOCPassbookUAT/webresources/customerService/getCustomerByNic/"+nic,    //UAT url                                                 
                                                        "method": "GET",
                                    ...
                                    if(searchop!=='nic' && searchop==='mobile')
                                    {
                                         ...
                                         mobile = searchval;                                    
                                                    var settings = {
                                                        "async": false,
                                                        "crossDomain": true,
                                                        "url": "https://passbook.boc.lk/BOCPassbook/webresources/customerService/getCustomerByMobile/"+mobile,  //LIVE
                                                        //"url": "https://passbook.boc.lk/BOCPassbookUAT/webresources/customerService/getCustomerByMobile/"+mobile,  //UAT
                                                        "method": "GET",
                                                        "content-type": "application/json",
                                                    }
                                    }
