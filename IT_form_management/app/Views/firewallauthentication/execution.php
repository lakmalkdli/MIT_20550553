...
<?= $this->section('baselayout') ?>
                            ...
                            <form action="<?php echo base_url('/requests/approval/'.$datasearch_by_Id['req_id']);?>" method="post" accept-charset="utf-8">
                                ...
                                <h4 class="card-title">Information about the access request</h4>
                                    ...
                                    <div class="form-row">     
                                                ...
                                                <div class="form-group">                                            
                                                <textarea class="form-control h-150px w-100" id="sec_comment" name="sec_comment" disabled><?php echo $datasearch_by_Id["itseccomment"] ?></textarea>
                                                </div>
                                                </div> 
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                                        ...
                                                        <select id="authManager" class="form-control" disabled>
                                                            ...
                                                            <option value="<?php echo $secmanager->u_id; ?>" <?php echo ($datasearch_by_Id['auth_by'] == $umanager->u_id) ? 'selected' : ''; ?>><?php echo $secmanager->u_fname; ?></option>
                                                            <?php } ?>       
                                                        </select>
                                        </div>
                                    </div>
                                    <h4 class="card-title">Network Deployement Information</h4>
                                    <div class="form-row">     
                                                <div class="form-group col-md-12">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                                        ...
                                                        <select id="exeofficer" class="form-control">
                                                            <?php foreach($authofficer as $exeofficer) { ?>
                                                            <option value="<?php echo $exeofficer->u_id; ?>" <?php echo ($authofficer[0]->u_id == $exeofficer->u_id) ? 'selected' : ''; ?>><?php echo $exeofficer->u_fname; ?></option>
                                                            <?php } ?>       
                                                        </select>
                                        </div>
                                    </div>
    ...
    ***********************************-->
    ...
    function approveRequest() {
        ...
        $.post("<?php echo base_url();?>"+"/requests/execute",
        {
            id: $('#aprroval_id').val(),
            comment: $('textarea#exe_comment').val(),
            executeby: $('#exeofficer :selected').val(),
            type: 'approved'
        },
        function(response) {
