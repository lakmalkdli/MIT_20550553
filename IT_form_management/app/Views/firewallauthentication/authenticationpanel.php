                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="<?php echo base_url('/requests/save'); ?>" method="post" accept-charset="utf-8">
                                <h4 class="card-title">Pending Firewall Request For Authorize</h4>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="myTable" class="display table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
                                            <?php foreach ($pendingAuthrequests as $request) : ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><span><a href="<?php echo base_url('requests/getauthitem/' . $request->req_id); ?>" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-pencil color-muted m-r-5"></i> </a>
                                                            </span>
                                                    </td>
                                                </tr>
                                            <?php endforeach ?>
