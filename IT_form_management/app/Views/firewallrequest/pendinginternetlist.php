                                ...
                                <h4 class="card-title">Pending Internet Requests to Apply</h4>
                                                    <div class="table-responsive">
                                                        <table id="myTable" class="display table table-striped table-bordered zero-configuration">
                                                            ...
                                                            <tbody>
                                                                <?php foreach ($pendingInternetRequests as $request): ?>	
                                                                <tr>                                                                   
                                                                    ...
                                                                    <td class="text-center"><span><a href="<?php echo base_url('requests/getauthIntitem/' . $request['intreq_id']); ?>" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-pencil color-muted m-r-5"></i> </a></span>                                             
                                                                    </td>
                                                                </tr>
                                                                <?php endforeach ?>
                                                            </tbody>                                                            
