                    ...
                    <div class="basic-form">
                        ...
                        <div class="table-responsive">
                            <table id="repTable" class="display table table-striped table-bordered zero-configuration">
                                ...
                                <?php foreach ($firewallreqdata as $request): ?>	
                                    <tr>                                                                   
                                        ...
                                        <td>
                                        <?php
                                            if ($request-> isntwrkdeployed == 0) {
                                                echo '<span class="flag-style-yellow">Pending </span>';
                                            }else if ($request-> isntwrkdeployed == 2) {
                                                echo '<span class="flag-style-red">Rejected </span>';
                                            }else if ($request-> isntwrkdeployed == 1) {
                                                echo '<span class="flag-style-green">Approved </span>';
                                            }
                                        ?>   
                                        </td>
    ...
    ***********************************-->
    ...
    <script type="text/javascript">
        ...
        $('#tblsearchbtn').click(function () {
            ...
            $.ajax({
                url: "<?php echo site_url('frepo/fwaccessdreport/search'); ?>",
                method: "POST",
                ...
                success: function (data) {
                    ...
                    new DataTable('#repTable', {
                        ...
                        columns: [
                            ...
                            { data: 'effectdate', title: "Effective Date" },
                            { data: 'expiredate', title: "Expire Date" },
                            { data: 'source', title: "Source IP" },
                            { data: 'destination', title: "Des IP" },
                            { data: 'ports', title: "Ports" },
                            { data: 'explanation', title: "Explanation" },
                        ],
                        layout: {
                            topStart: {
                                buttons: ['copy', 'csv', 'excel', 'pdf', 'print']
