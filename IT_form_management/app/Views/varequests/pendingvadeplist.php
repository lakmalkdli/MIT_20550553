                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="" method="post" accept-charset="utf-8">
                                <h4 class="card-title">Pending VA Requests to Execute</h4>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>                                                                   
                                                                    ...
                                                                    <td class="text-center">
                                                                        ...
                                                                        ?>
                                                                    <td class="text-center"><span><a href="<?php echo base_url('requests/getpendingvadep/'.$request->req_id);?>" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-pencil color-muted m-r-5"></i> </a>
                                                                        </span>                                                                    
                                                                    </td>
                                                                </tr>
                                                                <?php endforeach ?>
